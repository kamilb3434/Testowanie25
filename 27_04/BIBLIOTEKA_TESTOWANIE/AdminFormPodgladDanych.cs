...
namespace BIBLIOTEKA_TESTOWANIE
{
    public partial class AdminFormPodgladDanych : Form
    {
        ...
        private void WczytajDane()
        {
            ...
            {
                conn.Open();
                string query = @"SELECT u.*, a.Miejscowosc, a.Kod_pocztowy, a.Ulica, a.Numer_ulicy, a.Numer_lokalu, r.Nazwa_Roli AS Rola, u.Plec AS Plec
       ...
       private void buttonEdytuj_Click_1(object sender, EventArgs e)
        ...
        private void buttonZapis_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                string query = @"SELECT u.*, a.Miejscowosc, a.Kod_pocztowy, a.Ulica, a.Numer_ulicy, a.Numer_lokalu, r.Nazwa_rolI, u.Plec
                                 FROM dbo.Uzytkownik u
                                 INNER JOIN dbo.Adres a ON u.FK_ID_adres = a.ID_adres
                                 INNER JOIN dbo.Rola r ON u.FK_ID_rola = r.ID_rola
                                 WHERE u.ID_uzytkownik = @ID";
                ...
                zmieniono |= reader["Nazwa_rolI"].ToString() != comboBoxRola.Text;
            ...
            private void InitializeComponent()
        {
            ...
            // buttonZapis
            // 
            this.buttonZapis.Location = new System.Drawing.Point(614, 295);
            this.buttonZapis.Name = "buttonZapis";
            this.buttonZapis.Size = new System.Drawing.Size(123, 23);
